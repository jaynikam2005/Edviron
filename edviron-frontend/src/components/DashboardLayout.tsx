          ...
          <ul className="space-y-2">
            {navigation.map((item) => {
              const isActive = location.pathname === item.href || 
                (item.href === '/transactions' && location.pathname.startsWith('/transactions') && location.pathname !== '/transaction-status');
        ...
        <div className="flex-shrink-0 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                <span className="text-xs text-gray-500 dark:text-gray-400 mr-2 hidden sm:block">Theme</span>
                <ThemeToggle />
              </div>
